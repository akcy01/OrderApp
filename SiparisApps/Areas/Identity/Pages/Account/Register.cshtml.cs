...
using SiparisApps.Data.Repository;
using SiparisApps.Data.Repository.IRepository;
using SiparisApps.Models;

namespace SiparisApps.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            //Rolleri Oluşturuyorum
            /* Admin isminde rol yoksa aşağıdakileri gerçekleştir dedik */
